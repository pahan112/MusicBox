...
public class FragmentDay extends Fragment implements FragmentAdapter.OnClickDelete{
    ...
    private void addMusic(){
        ...
        lm = SQLite.select().from(PlayListModel.class).where(PlayListModel_Table.nameList.is("day")).queryList();
